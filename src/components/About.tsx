          ...
          <div ref={leftSectionRef} className="mb-12 lg:mb-0 scroll-slide-left">
            <div>
              ...
              <a
                ...
                download
                className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-pink-500 text-white px-6 py-3 rounded-lg font-medium hover:from-cyan-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-200 shadow-lg neon-glow"
              >
